...
{
    // <game>/Mods/FloatingDamage/KCSE/Plugins/FloatingDamage.dll
    //   -> <game>/Mods/FloatingDamage/mod.cfg
    HMODULE hm = nullptr;
...
void WriteCfg()
{
    ...
    if (!f)
        return;
    f << "-- Floating Damage settings - auto-generated from the MCM menu; the game applies this\n"
