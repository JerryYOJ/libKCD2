...
public:
    ...
    CryStringT<char> GetAttachmentName() const override; // [2] 0x1809735B4
    void ApplyToAttachment(IAttachment* target) const override; // [3] 0x1803B6E80
    bool IsComplete() const override; // [4] 0x18097354C
    CryStringT<char> GetMissingAttributes() const override; // [5] 0x18295E5C0
    std::int32_t GetEquipmentPartId() const override;                    // [6] 0x181A72970
    const S_EquipmentPart* GetEquipmentPartRecord() const override; // [7] 0x1809735F4
    ...
    CryStringT<char> GetJointName() const override; // [11] 0x181437814
    bool IsFinalLayer() const override;                                  // [12] 0x1809734EC
    bool KeepBodyLayer() const override;                                 // [13] 0x1809734D4
    bool TryGetEquipmentPartLayerOrder(std::uint32_t* equipmentPartId, std::uint32_t* layerOrder) const override;              // [14] 0x180E11ED8
    bool unk_15() const override;                                       // [15] 0x180838AE0
    void SetAttachmentNamePrefix(const CryStringT<char>& value) override; // [16] 0x1803B6E80
    bool HasModelAsset() const override; // [17] 0x180973628
    bool HasMaterialAsset() const override; // [18] 0x180973658
    bool IsDummyModel() const override; // [19] 0x180973688
    std::vector<CryStringT<char>> GetAssetPaths() const override; // [20] 0x18295E22C
    void MergeFrom(const C_ElementBase* source) override; // [21] 0x181239CA0
    bool IsEquivalentTo(const C_ElementBase* other) const override; // [22] 0x18119BC90
    bool CanMergeWith(const C_ElementBase* other) const override; // [23] 0x1810D743C
    bool MatchesEquipmentPart(std::int32_t equipmentPartId) const override; // [24] 0x1810D7494
