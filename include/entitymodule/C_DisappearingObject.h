...
class C_DisappearingObject
    : public Offsets::CGameObjectExtensionHelper<
          C_DisappearingObject,
          Offsets::IGameObjectExtension,
          64> {
public:
    inline static constexpr auto RTTI = Offsets::RTTI_C_DisappearingObject;

    ~C_DisappearingObject() override;                                  // [0] 0x18116D748
    ...
    void PostInit(Offsets::IGameObject* gameObject) override;          // [8] 0x182AAA408
    ...
    bool GetEntityPoolSignature(TSerialize signature) override;       // [13] 0x182AA71C4
    ...
    void Update(SEntityUpdateContext& context, int updateSlot) override; // [22] 0x182AAE580
    ...
    const void* GetRMIBase() const override;                           // [26] 0x181AB4C00
    void PostUpdate(float frameTime) override;                         // [27] nullsub_1
    void PostRemoteSpawn() override;                                   // [28] nullsub_1
};
static_assert(sizeof(C_DisappearingObject) == 0x40,
              "C_DisappearingObject must be 0x40");
