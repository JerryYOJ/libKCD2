...
// S_ReputationChangeDBData>, int> -> ... -> I_ObjectDatabase. The separate concrete
// CryGUID-to-row hash begins at +0xB0.
...
public:
    ...
    // +0xB0  GUID -> row lookup; pointee cv-qualification remains OPEN.
    std::unordered_map<CryGUID, S_ReputationChange*,
                       wh::shared::S_DefaultHash<CryGUID>> m_idIndex;
};
