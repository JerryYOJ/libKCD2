...
public:
    ...
    void*              m_listSentinel70;    // +0x70  32-byte intrusive-list sentinel node (self-linked, sub_1804F75C0(32))
    uint8_t            _unk78[8];           // +0x78  [U]
    ...
    void*              m_B0;                // +0xB0  (sub_180413784; freed in dtor) [U pointee]
    uint8_t            _unkB8[8];           // +0xB8  [U]
    std::vector<void*> m_vecC0;             // +0xC0  elem 8
    uint8_t            _unkD8[0x10];        // +0xD8  [U]
