...
class C_SchedulerEffectSoil : public C_SchedulerEffectBase {
public:
    ~C_SchedulerEffectSoil() override;
...
static_assert(sizeof(C_SchedulerEffectSoil) == 0x18,
              "C_SchedulerEffectSoil size mismatch");
