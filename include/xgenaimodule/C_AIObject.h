...
// in C_AIObjectManager (q_185481FC8) hashmap @mgr+0x60 keyed by the root AI-object
// WUID at +0x08 (insert node+0x18 = this, then two notify calls). Dtor sub_18047B6A4 (via slot-0 deleting
...
public:
    ...
    framework::WUID m_wuid;              // +0x08  canonical AI-object identity and root-manager key [V]
