...
// -----------------------------------------------
// wh::xgenaimodule::NPCState::C_OpenShopElement : I_Element
...
class C_OpenShopElement : public I_Element {
public:
    ~C_OpenShopElement() override;
...
static_assert(offsetof(C_OpenShopElement, m_unknown18) == 0x18,
              "C_OpenShopElement::m_unknown18 offset mismatch");
static_assert(sizeof(C_OpenShopElement) == 0x28,
              "C_OpenShopElement size mismatch");
