...
public:
    ...
    I_Element* unk_09() override;                         // [9] 0x181301DA8 clone
    std::uint64_t unk_10() override;                      // [10] 0x180AFC7BC
    bool unk_24() override;                               // [24] 0x18041A6A0 true
    bool unk_25() override;                               // [25] 0x18041A6A0 true
