...
// -----------------------------------------------
// wh::xgenaimodule::NPCState::C_MinigameElement : I_Element
...
class C_MinigameElement : public I_Element {
public:
    ~C_MinigameElement() override;
...
static_assert(offsetof(C_MinigameElement, m_unknown18) == 0x18,
              "C_MinigameElement::m_unknown18 offset mismatch");
static_assert(sizeof(C_MinigameElement) == 0x30,
              "C_MinigameElement size mismatch");
