...
// (KCD2 WHGame.dll 1.5.6, kd7u).  sizeof >= 0x28; allocation size NOT create-site
...
public:
    ...
    void**   m_targetsBegin;     // +0x18  target-range begin (searched by sub_181C1D7F0) [V]
    void**   m_targetsEnd;       // +0x20  target-range end [V]
};
// sizeof >= 0x28; not create-site proven -> no static_assert [U]
