...
struct ISystem {
    ...
    virtual uint32_t _vf37() const = 0;                             // [37]  0x128  predicate on [+0x2BA4] in {0x13,0x22,0x14} or byte [+0x2BE1] (not a plain getter)
    ...
    virtual void* GetIZLibCompressor() = 0;                         // [50]  0x190  ret [+0xA00] CZLibCompressor* (old GetIRenderer_unk label was wrong)
    virtual void* GetIZLibDecompressor() = 0;                       // [51]  0x198  ret [+0xA08] CZLibDecompressor*
    virtual void* GetLZ4Decompressor() = 0;                         // [52]  0x1A0  ret [+0xA10] CLZ4Decompressor*
    ...
    virtual void* GetIBudgetingSystem() = 0;                        // [59]  0x1D8  ret [+0x9F8] CBudgetingSystem*
    ...
    virtual void* _vf195() = 0;                                     // [195] 0x618  aggregates avg/min/max over the 16B-record vector at [+0x2B70] (old "ret [+0x2B78]" was wrong)
