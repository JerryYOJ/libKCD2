...
#elif defined(APPLE) || defined(LINUX64) && defined(__clang__)
template <class _I>
inline bool operator ==(const _smart_ptr<_I> &p1, long)	
{
	return !(bool)p1;	
}
template <class _I>
...
template <class _I>
inline bool operator ==(long, const _smart_ptr<_I> &p1)
{
	return !(bool)p1;	
}
template <class _I>
