...
public:
    ...
    void OnEntitySideEffectAdded(std::uint8_t sideEffectId, ::wh::framework::WUID entityWuid) override {}   // [0]+[1] ICF-folded onto sub_182767740
    void OnEntitySideEffectRemoved(std::uint8_t sideEffectId, ::wh::framework::WUID entityWuid) override {} // same folded handler
