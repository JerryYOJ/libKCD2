...
public:
    ...
    C_CombatActionTriggerData* m_pMatchedRule; // +0x20  non-owning ptr to matched 20-byte rule record inside a global vector (begin/end @ xmmword_185320320); set in update sub_181418588 @0x182360515 = sub_1814185EC(this,actor); rule.float@+0xC arms m_time18, rule.dword@+0x8 builds a spawn request, reset to 0 (NOT released) @0x18236059B
