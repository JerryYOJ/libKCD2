...
public:
    ...
    virtual bool IsStarted() const= 0; // [8]
    virtual std::uint32_t GetTargetEntityId() const= 0; // [9]
    ...
    virtual bool ShouldBindMinigameActionMap() const= 0; // [23]
    virtual void unk_24() = 0;                               // [24]
    virtual bool CheckPrimitiveWorldIntersection(const float* fromXform, const float* toPos)= 0; // [25]
    virtual void unk_26() = 0;                               // [26]
    virtual void unk_27() = 0;                               // [27]
    virtual void unk_28() = 0;                               // [28]
    virtual _smart_ptr<framework::I_Action> CreatePlayerAction()= 0; // [29]
    virtual void FillSessionInfo(/*S_MinigameSessionInfo*/ void* out)= 0; // [30]
    ...
    virtual bool TransformByEntitySlot(void* entity, void* slotKey, bool skipWorldTM, float* outVec3, const float* inVec3)= 0; // [40]
    virtual void* GetEntityCharacter(void* entity)= 0; // [41]
    virtual std::uint32_t StartEntityAnimation(CryStringT<char> name, void* entity)= 0; // [42]
    virtual void StopEntityAnimation(std::uint32_t animId, std::uint32_t entityId)= 0; // [43]
