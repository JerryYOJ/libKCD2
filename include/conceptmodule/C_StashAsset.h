...
// -----------------------------------------------
// wh::conceptmodule::C_StashAsset : C_BaseAsset
...
class C_StashAsset : public C_BaseAsset {
public:
    ~C_StashAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_StashAsset) == 0x18,
              "C_StashAsset size mismatch");
