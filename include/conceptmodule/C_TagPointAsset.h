...
// -----------------------------------------------
// wh::conceptmodule::C_TagPointAsset : C_BaseAsset
...
class C_TagPointAsset : public C_BaseAsset {
public:
    ~C_TagPointAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_TagPointAsset) == 0x18,
              "C_TagPointAsset size mismatch");
