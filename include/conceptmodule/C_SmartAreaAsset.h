...
// -----------------------------------------------
// wh::conceptmodule::C_SmartAreaAsset : C_BaseAsset
...
class C_SmartAreaAsset : public C_BaseAsset {
public:
    ~C_SmartAreaAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_SmartAreaAsset) == 0x18,
              "C_SmartAreaAsset size mismatch");
