...
// -----------------------------------------------
// wh::conceptmodule::C_ItemSlotAsset : C_BaseAsset
...
class C_ItemSlotAsset : public C_BaseAsset {
public:
    ~C_ItemSlotAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_ItemSlotAsset) == 0x18,
              "C_ItemSlotAsset size mismatch");
