...
public:
    ...
    bool IsDeprecated() const override; // [10] 0x181E2AE20
    ...
    bool IsInternal() const override; // [14] 0x182627E24
    ...
    std::vector<CryStringT<char>> GetValueOriginConstraints() const override; // [19] 0x181E2AC90
    std::shared_ptr<I_PortDefinition> GetRuntimeDefinition() const override; // [20] 0x182627548
