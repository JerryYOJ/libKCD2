...
// -----------------------------------------------
// wh::conceptmodule::C_ShopAsset : C_BaseAsset
...
class C_ShopAsset : public C_BaseAsset {
public:
    ~C_ShopAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_ShopAsset) == 0x18,
              "C_ShopAsset size mismatch");
