...
// -----------------------------------------------
// wh::conceptmodule::C_TriggerAreaAsset : C_BaseAsset
...
class C_TriggerAreaAsset : public C_BaseAsset {
public:
    ~C_TriggerAreaAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_TriggerAreaAsset) == 0x18,
              "C_TriggerAreaAsset size mismatch");
