...
// -----------------------------------------------
// wh::conceptmodule::C_FactionBaseAsset : C_BaseAsset
...
class C_FactionBaseAsset : public C_BaseAsset {
public:
    ~C_FactionBaseAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_FactionBaseAsset) == 0x18,
              "C_FactionBaseAsset size mismatch");
