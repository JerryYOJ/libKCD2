...
// -----------------------------------------------
// wh::conceptmodule::C_AreaUnionAsset : C_BaseAsset
...
class C_AreaUnionAsset : public C_BaseAsset {
public:
    ~C_AreaUnionAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_AreaUnionAsset) == 0x18,
              "C_AreaUnionAsset size mismatch");
