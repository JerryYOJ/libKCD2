...
public:
    ...
    virtual bool IsDeprecated() const= 0; // [10] metadata key 5
    ...
    virtual bool IsInternal() const= 0; // [14] metadata key 6
    ...
    virtual std::vector<CryStringT<char>> GetValueOriginConstraints() const = 0; // [19] metadata key 16
    virtual std::shared_ptr<I_PortDefinition> GetRuntimeDefinition() const= 0; // [20] cached/copy/null by implementation
};
