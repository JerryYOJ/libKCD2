...
// -----------------------------------------------
// wh::conceptmodule::C_AnimCharAsset : C_BaseAsset
...
class C_AnimCharAsset : public C_BaseAsset {
public:
    ~C_AnimCharAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_AnimCharAsset) == 0x18,
              "C_AnimCharAsset size mismatch");
