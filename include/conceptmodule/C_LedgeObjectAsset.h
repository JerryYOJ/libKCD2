...
// -----------------------------------------------
// wh::conceptmodule::C_LedgeObjectAsset : C_BaseAsset
...
class C_LedgeObjectAsset : public C_BaseAsset {
public:
    ~C_LedgeObjectAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_LedgeObjectAsset) == 0x18,
              "C_LedgeObjectAsset size mismatch");
