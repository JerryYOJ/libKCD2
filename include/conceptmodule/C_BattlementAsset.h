...
// -----------------------------------------------
// wh::conceptmodule::C_BattlementAsset : C_BaseAsset
...
class C_BattlementAsset : public C_BaseAsset {
public:
    ~C_BattlementAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_BattlementAsset) == 0x18,
              "C_BattlementAsset size mismatch");
