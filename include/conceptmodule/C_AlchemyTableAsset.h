...
// -----------------------------------------------
// wh::conceptmodule::C_AlchemyTableAsset : C_BaseAsset
...
class C_AlchemyTableAsset : public C_BaseAsset {
public:
    ~C_AlchemyTableAsset() override;                                   // [0]
    RTTR_ENABLE(C_BaseAsset)                              // [2..4]
};

static_assert(sizeof(C_AlchemyTableAsset) == 0x18,
              "C_AlchemyTableAsset size mismatch");
